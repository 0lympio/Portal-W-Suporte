        ...
        <div class="sm:max-w-md mb-3 py-4 sm:rounded-sm p-3 flex justify-center">
            <form method="POST" :action="'companies/' + company.id">
                ...
                <div class="mt-4">
                    ...
                    <x-input class="input-form" type="text" name="name" required maxlength="255" x-model="company.name" />
                </div>
                <div class="mt-4">
                    <x-label for="description" value="Descrição (opcional)" />
                    <x-input class="input-form" type="text" name="description" maxlength="255" x-model="company.description" />
                </div>

                <div class="flex items-center justify-end mt-4">
                    <x-button type="button" class="button-red" @click="editModal=false;">
                        Cancelar
                    </x-button>
